                    ...
                    <div className="operation-space">
                        <div className="from-to-container" >
                            ...
                            <div className="list-units-container">
                                ...
                                <span>
                                    <input type="radio" className="radio-input" checked value="Cm" onChange={handleUnit1Change} name="length-from" id="length-from2" />
                        ...
                        <div className="from-to-container">
                            ...
                            <div>
                                <div className="list-units-container">
                                    ...
                                    <span>
                                        <input type="radio" className="radio-input" checked value="M" onChange={handleUnit2Change} name="length-to" id="length-to4" />
