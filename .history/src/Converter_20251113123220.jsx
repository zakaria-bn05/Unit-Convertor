...
function Converter() {
                    ...
                    <div className="operation-space">
                        <div className="from-to-container" >
                            ...
                            <div className="list-units-container">
                                ...
                                <span>
                                    <input type="radio" className="radio-input" defaultChecked value="Cm" onChange={handleUnit1Change} name="length-from" id="length-from2" />
                        ...
                        <div className="from-to-container">
                            ...
                            <div>
                                <div className="list-units-container">
                                    ...
                                    <span>
                                        <input type="radio" className="radio-input" defaultChecked value="M" onChange={handleUnit2Change} name="length-to" id="length-to4" />
    ...
    return (
        <>
            <header>
                <a href="">
                    <img src={logoIcon} alt="" width={"120px"} />
                </a>
